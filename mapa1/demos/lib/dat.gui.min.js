/* Propósito: Libreria que controla el Panel de Control del prototipo.
Entidad: DANE
Fecha actualizado: 22/12/2015
Cambio realizado: Cambio label {'Close Controls' => 'Cierre Controles'} atributo TEXT_CLOSED; cambio label {'Open Controls' => 'Abrir Controles'} atributo TEXT_OPEN
Fecha actualizado: 22/12/2015
Cambio realizado: Actualización color a las clases 'close-button', 'string', 'function', 'title', 'boolean' y combos select {'#000'=>'#b6014c'}; reemplazo color { '#b6014c'=> '#8E013B'}
Observaciones: Versión Condensada
*/
